...
<div id="add-course-form" class="hidden" >
    <div class="overlay">
        <form class="card card-add-form mx-auto" action="../TrainingServlet" method="GET" style="transition: ease-in 0.5s">
            <i id="add-course-close" class="fas fa-times"></i>
            <h3 class="form-heading">Add New Training</h3>
            <input type="hidden" name="command" value="ADD" />
            <div class="form-group">
                <input type="text" name="trainingDate" placeholder="Training Date" value="" />
            </div>s
            <div class="form-group">
                <input type="text" name="trainingTime" placeholder="Training Time" value="" />
            </div>
            <div class="form-group">
