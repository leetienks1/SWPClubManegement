<%-- 
    Document   : playerphysicalcondition
    Created on : Jul 4, 2024, 3:27:59 PM
    Author     : Hoa-Nguyen
--%>
...
<div class="nav-logo" style="cursor: pointer" onclick=" window.location.href = '/SWPClubManegement/HomeServlet'"> <img src="../IMAGE/HOME/logo 1.png" alt="alt"/> </div>
            ...
            <div id="content" style="width: 100%;">
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <span class="navbar-text"><h4>List PlayerPhysicalondition</h4></span>
                    </div>
                </nav>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="p4"  items="${playerPhysicalConditions}">
                            <c:url var="deleteLink" value="../PlayerPhysicalConditionController">
                                ...
                                <c:param name="conditionID" value="${p4.conditionID}"></c:param>
                            </c:url>
        ...
        <%@include file="addplayerphysicalcondition.jsp" %>
        <%@include file="editplayerphysicalcondition.jsp" %>
    </body>
    <script>
