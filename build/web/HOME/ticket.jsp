                                            ...
                                            <c:choose >
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <div class="modal fade" id="QR-${status.index}"
                                                         tabindex="-1">
                                                        <div
                                                            class="modal-dialog modal-dialog-centered modal-lg" style="margin: 0;
                                                            width: 1500px;
                                                            max-width: 1500px;
                                                            height: 700px;
                                                            max-height: 1000px;">
                                                            <div class="modal-content" style="height: 100%;">
                                                                ...
                                                                <div
                                                                    class="modal-body d-flex justify-content-start ">
                                                                    <div class="col-md-8" style="
                                                                         background-image: url('https://scontent.fsgn5-5.fna.fbcdn.net/v/t1.15752-9/450386838_1953729368363571_5543766825402038372_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=9f807c&_nc_eui2=AeFUFzB_-9WebmLeqIr6MxMxlQdcWCZFb--VB1xYJkVv7zQzd6WHNgp2-nNMB0XRPDvPrSbcD0gXFT-C-hflNOkt&_nc_ohc=E02S6eAobRYQ7kNvgEFC6Xh&_nc_ht=scontent.fsgn5-5.fna&oh=03_Q7cD1QF3WWAcG8o_ZQUiRDA6YCxpd2c7tB0Z7K9e75YYhkqVDw&oe=66B45801');
                                                                         ...
                                                                         padding: 10px;
                                                                         ">
                                                                        <div class="zone zone-a d-flex flex-wrap gap-2">
                                                                            <c:forEach
                                                                                items="${match.tickets}"
                                                                                var="ticket">
                                                                                <c:if test="${ticket.getSeatNumber() != null && ticket.getSeatNumber().contains('A')}">
                                                                        ...
                                                                        <div class="zone zone-b d-flex flex-column gap-2" style="">
                                                                            <c:forEach
                                                                                items="${match.tickets}"
                                                                                var="ticket">
                                                                                <c:if test="${ticket.getSeatNumber() != null && ticket.getSeatNumber().contains('B')}">
                                                                                    <input hidden type="radio"
                                                                                           id="ticket-${ticket.ticketId}"
                                                                                           name="seatNumber"
                                                                                           value="${ticket.ticketId}" ${match.ticketPurchaseMap.containsKey(ticket.ticketId) ? 'disabled' : ''}/>
                                                                        ...
                                                                        <div class=" zone zone-c d-flex  gap-2" style=" ">
                                                                            <c:forEach
                                                                                items="${match.tickets}"
                                                                                var="ticket">
                                                                                <c:if test="${ticket.getSeatNumber() != null && ticket.getSeatNumber().contains('C')}">
                                                                                    <input hidden type="radio"
                                                                                           id="ticket-${ticket.ticketId}"
                                                                                           name="seatNumber"
                                                                                           value="${ticket.ticketId}" ${match.ticketPurchaseMap.containsKey(ticket.ticketId) ? 'disabled' : ''}/>
                                                                        ...
                                                                        <div class=" zone zone-d d-flex  gap-2" style=" ">
                                                                            <c:forEach
                                                                                items="${match.tickets}"
                                                                                var="ticket">
                                                                                <c:if test="${ticket.getSeatNumber() != null && ticket.getSeatNumber().contains('D')}">
                                                                                    <input hidden type="radio"
                                                                                           id="ticket-${ticket.ticketId}"
                                                                                           name="seatNumber"
                                                                                           value="${ticket.ticketId}" ${match.ticketPurchaseMap.containsKey(ticket.ticketId) ? 'disabled' : ''}/>
