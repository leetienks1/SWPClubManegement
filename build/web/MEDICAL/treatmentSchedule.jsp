<%-- 
    Document   : TreatmentSchedule
    Created on : Jul 4, 2024, 3:42:47 PM
    Author     : Hoa-Nguyen
--%>
...
<html>
    ...
    <body>
            ...
            <div id="content" style="width: 100%;">
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <span class="navbar-text"><h4>list TreatmentSchedule</h4></span>
                    </div>
                </nav>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="p3"  items="${treatmentSchedules}">
                            <c:url var="deleteLink" value="../TreatmentScheduleController">
                                ...
                                <c:param name="treatmentID" value="${p3.treatmentID}"></c:param>
                            </c:url>
                            ...
                            <tr>
                                ...
                                <td>${p3.treatmentDate}</td>
                                <td>${p3.treatmentTime}</td>
                                <td>${p3.treatmentDescription}</td>
                                <td>
                                    <a class="update-button" href="treatmentSchedule.jsp?dip=${p3.treatmentID}&uid=${p3.playerID}&open=openedit" onclick="event.handleLinkClick(event);"> <i class="fas fa-edit"></i></a>
        ...
        <%@include file="addtreatmentschedule.jsp" %>
        <%@include file="edittreatmentschedule.jsp" %>
    </body>
    <script>
