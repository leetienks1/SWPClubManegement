...
public class VnPayPaymentService extends AbstractTicketPurchasePaymentService {
    ...
    @Override
    public PaymentResponse payment(HttpServletRequest req, HttpServletResponse reps, Map<String, Object> header) throws IOException {
        ...
        final Properties properties = (Properties) req.getServletContext().getAttribute(AppConstant.APPLICATION_CONFIG_KEY);
        ...
        vnp_Params.put("vnp_Version", properties.getProperty("vnpay.version"));
        vnp_Params.put("vnp_Command", "pay");
        vnp_Params.put("vnp_TmnCode", properties.getProperty("vnpay.tmn-code"));
        vnp_Params.put("vnp_Amount", String.valueOf(amount));
        vnp_Params.put("vnp_CurrCode", "VND");
        vnp_Params.put("vnp_TxnRef", ticketPurchase.getPurchaseID().toString());
        vnp_Params.put("vnp_OrderInfo", String.format(orderInfoTemplate, ticketPurchase.getPurchaseID()));
        vnp_Params.put("vnp_OrderType", "other");

        vnp_Params.put("vnp_Locale", "vn");
        vnp_Params.put("vnp_ReturnUrl", properties.getProperty("vnpay.return-url"));
    ...
    @Override
    public GetPaymentResponse query(TicketPurchase ticketPurchase, Properties properties) {
        ...
        String vnp_OrderInfo = String.format(properties.getProperty("vnpay.order-info-template"), ticketPurchase.getPurchaseID());
        ...
        String vnp_SecureHash = VnpayUtils.hmacSHA512(properties.getProperty("vnpay.secret-key"), hash_Data);
        ...
        try {
            ...
            in.close();
            final VnPayPaymentResponse vnPayPaymentResponse = gson.fromJson(response.toString(), VnPayPaymentResponse.class);
