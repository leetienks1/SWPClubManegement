...
public class OrderJerseyDetails {
    ...
    public OrderJerseyDetails(int orderDetailID, int orderID, int jerseySizeID, int jerseyID, int jerseyQuantity) {
    ...
    public OrderJerseyDetails(int orderID, int jerseySizeID, int jerseyID, int jerseyQuantity) {
        this.orderID = orderID;
        this.jerseySizeID = jerseySizeID;
        this.jerseyID = jerseyID;
        this.jerseyQuantity = jerseyQuantity;
