...
public class EditTeamServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditTeamServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditTeamServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
            ...
            while (it.hasNext()) {
                ...
                if (fileItem.isFormField()) {
                    ...
                    if (fileItem.getSize() > 0) {
                        ...
                        String path = request.getServletContext().getRealPath("IMAGE\\TEAM");
...
//                        String filePath = "SWPWedRealClubManagement\\web\\IMAGE/AVATAR\\" + file_name;
            ...
            teamName = formFields.get("teamname1");
            flag = "/SWPClubManegement/IMAGE/TEAM/" + formFields.get("flag1");
            stadium =formFields.get("stadium1");
            TeamDAO tdao = new TeamDAO();
            Team team = tdao.get(nid).get();
            team.setTeamName(teamName);
            team.setStadium(stadium);
            if (file_name != null) {
                team.setFlag("/SWPClubManegement/IMAGE/TEAM/" + file_name);
            }
