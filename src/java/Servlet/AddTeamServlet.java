...
public class AddTeamServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddTeamServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddTeamServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//            int nid = Integer.parseInt(formFields.get("nid"));
            teamName = formFields.get("teamname");
            flag = "/SWPClubManegement/IMAGE/TEAM/" + formFields.get("flag1");
            stadium = formFields.get("stadium");
